		...
		<div class="container title-order">
			<div class="row">
				<div class="col-md-8 col-sm-6">
		        	<a class="prev-page" href="products.html"><span class="fa fa-chevron-left"></span> continue shopping</a>
		        </div>
		...
		<div class="container order-received">
			<div class="row">
				<div class="col-md-10 push-md-1">
					...
					<p>Your order number is: 9881698</p>
				...
				<div class="col-md-10 push-md-1 text-sm-right text-xs-center">
					<a href="products.html" class="btn btn-chocolate">Continue shopping</a>
				</div>
			</div><!-- end row -->
		</div><!-- end container -->
	</div><!-- end ... -->
