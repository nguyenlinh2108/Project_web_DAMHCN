<?php include('includes/header.php'); ?>
	...
	<div class="container-fluid banner-recipes our-s">
		<div class="bg-bannner">
			<div class="layer">
				<h2>THE SOURCE OF ALL OUR FLAVOR</h2>
				<p>Learn how THE PODS began, and discover how we craft our extraordinary chocolate<br>by sourcing quality cacao fron around the world.</p>
			</div>
		</div>
	</div><!-- end ... -->
