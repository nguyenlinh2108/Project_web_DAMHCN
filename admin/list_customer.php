                ...
                if($db->select($query))
                {
                    foreach ($db->getResult() as $obj)
                    {
                        ...
                        <tr>
                            ...
                            <td><?php echo $obj->time_block; ?></td>
                            <td><a href="edit_customer.php?id=<?php echo $obj->id; ?>"><img width="16px" src="../public/images/icon_edit.png"></a></td>
                            <td><a href="delete_customer.php?<?php echo $obj->id; ?>" onclick="return confirm('Bạn có thực sự muốn xóa không?')"><img width="16px" src="../public/images/icon_delete.png"></a></td>
                        </tr>
                        <?php
                    }
                }
