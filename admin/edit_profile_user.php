...
<div class="row">
    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="my_pad_top">
        <a href="profile_user.php?id=<?php if(isset($id)) echo $id; ?>" class="btn btn-primary" >Về trang thông tin</a>
        ...
        <form name="frmadd_user" id="frmadd_user" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="select-status" class="selectpicker show-tick" data-width="auto" title="Chọn quyền" disabled="">
                    <?php
